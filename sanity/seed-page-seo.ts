...
const defaultPages: any[] = [
  ...
  },
  {
    ...
    metaDescription: 'Strategia to fundament skutecznej strony. Strategia przedwdrożeniowa: cel biznesowy, buyer persony, UVP, architektura informacji. Dowiedz się więcej.',
    keywords: [
