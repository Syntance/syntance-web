...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return pageMetadata({
    ...
    ogDescription: `Profesjonalne strony www w Next.js z gwarancją PageSpeed 90+. Strategia marketingu i sprzedaży (faza przedwdrożeniowa). Strony od ${priceStr} PLN netto.`,
    keywords: [ 'tworzenie stron internetowych', 'strona internetowa dla firmy', 'profesjonalna strona internetowa', 'strony dla firm', 'strona www dla firmy', 'strona internetowa Next.js', 'strona B2B', 'szybka strona internetowa', 'tworzenie stron internetowych Kraków', 'strony internetowe Małopolska', 'agencja webowa Polska', ],
  })
}
