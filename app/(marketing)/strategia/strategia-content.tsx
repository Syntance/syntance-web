...
function getFaqItems(strategyPrice: number) {
  const formattedPrice = formatPrice(strategyPrice)
  return [
    {
    ...
    },
    {
      ...
      answer: `Tak. Każdy projekt strony lub sklepu zawiera uproszczoną wersję strategii w cenie. Pełna Strategia przedwdrożeniowa (${formattedPrice} PLN) to opcja dla firm, które chcą głębszej analizy.`
    },
    {
...
export default function StrategiaContent({ strategyPrice }: StrategiaContentProps) {
  const [heroVisible, setHeroVisible] = useState(false)
  const formattedPrice = formatPrice(strategyPrice)
  const faqItems = getFaqItems(strategyPrice)
                    ...
                    <div className="flex items-center justify-between gap-4 mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-3xl font-light text-white">{formattedPrice} PLN <span className="text-lg text-gray-400">netto</span></p>
                        </div>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
