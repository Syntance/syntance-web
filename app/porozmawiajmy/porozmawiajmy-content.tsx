...
const BULLETS = [
  'Pokażemy, co zmienilibyśmy na Twojej obecnej witrynie — konkret, nie ogólniki.',
  'Wycenimy projekt w oparciu o Twoje cele — realny zakres i kwota, bez „widełek dla marketingu”.',
  'Zero presji sprzedażowej — jeśli model współpracy nie pasuje, kończymy bez zobowiązań.',
]
      ...
      <main className="mx-auto max-w-[800px] px-6 pt-10 pb-24 md:px-10 md:pt-16">
        ...
        <section className="mb-16">
          ...
          <h1 className="mb-6 text-[clamp(1.9rem,5vw,3rem)] font-light leading-[1.1] tracking-tight text-white">
            Zespół Syntance —{' '}
            <span className="font-medium">software house</span> dla stron i sprzedaży online.
            <br className="hidden sm:block" />
            Umów <span className="text-purple-400">30 minut</span> — pokażemy, jak Twoja witryna może działać na
            konkretny wynik biznesowy.
          </h1>
        ...
        <section className="mb-16 text-center">
          <a
            href="mailto:kontakt@syntance.com?subject=Rozmowa%20z%20wizytówki"
          ...
          >
            ...
            Wolisz napisać? kontakt@syntance.com
          </a>
        </section>
      </main>
      ...
      <footer className="border-t border-white/5 px-6 py-8 md:px-10">
        <div className="mx-auto flex max-w-[800px] flex-col items-start justify-between gap-4 text-sm text-gray-500 md:flex-row md:items-center">
          <div>
            ...
            <span className="ml-2">— strategia, software house Next.js</span>
          </div>
